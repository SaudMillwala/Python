...
What Data Will I Use in This Homework? In this homework, you’ll gain access to two similar datasets that include passenger information like name, age, gender, socio-economic class, etc. One dataset is titled train.csv and the other is titled test.csv.
...
Following is the link to the Titanic: Machine Learning from Disaster competition https://www.kaggle.com/competitions/titanic
...
Before you perform prediction I would like you to do some Exploratory Data Analysis and pre-processing of the data. Follow the steps in the jupyter notebook to complete your homework.
Submission deadline: Thursday, April 21st (end of the day)
Submission guideline: Just submit the completed jupyter notebook